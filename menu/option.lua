...
local hl_color = catppuccin.TEXT
local non_hl_color = catppuccin.OVERLAY0
local hl_arrow = '> '
...
function MenuOption:draw(pos_factor)
  ...
  love.graphics.print({ self.text_color, self.arrow .. self.text }, self.font, pos_x - self.font:getWidth(self.arrow), pos_y + (text_height * pos_factor))
end
